...
/* ── CAME ── */
export type CameQuadrant = 'CORREGIR' | 'AFRONTAR' | 'MANTENER' | 'EXPLOTAR'

export type CameActionSummary = {
  id: number | null
  quadrant: CameQuadrant
  description: string
...
export type CameSummary = {
  planId: number | null
  corregir: CameActionSummary[]
  afrontar: CameActionSummary[]
  mantener: CameActionSummary[]
  explotar: CameActionSummary[]
  updatedAt: string
}
...
export type UpdateCamePayload = {
  corregir: CameActionPayload[]
  afrontar: CameActionPayload[]
  mantener: CameActionPayload[]
  explotar: CameActionPayload[]
}
